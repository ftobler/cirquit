...
export const SWITCH2_DEF: ElementDef = {
  ...
  // and last throw poles (Switch2Elm.java:121-123). The box is the tight union
  // of the lever centrelines, no growth: the picker's 8-pixel reach still
  // covers the drawn stroke, so a margin would only grab clicks the user aimed
  // past the lever. It is position-independent, so center-off still toggles
  // back onto a throw from anywhere in the fan.
  switchRect: (e) => {
