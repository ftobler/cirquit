...
describe('scope lines index the file, not the elements this build can read', () => {
  ...
  it('attaches each scope to the element the file meant', () => {
    ...
    // Two traces on the two resistors; the one on the unijunction has no
